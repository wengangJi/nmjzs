...
<%--<form:form id="searchForm" modelAttribute="company" action="${ctx}/comp/company/" method="post" class="breadcrumb form-search">
    ...
    <form:select id="queryType" path="queryType" class="input-small"><form:options items="${fns:getDictList('comp_query_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/></form:select>
