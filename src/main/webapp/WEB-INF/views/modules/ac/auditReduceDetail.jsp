...
<c:if test="${soHours.auditLevel eq '0'}">
    <form:form id="inputForm" modelAttribute="soHours" action="${ctx}/audit/reduceFirstAudit" method="post" class="form-horizontal">
        <form:hidden path="id"/>
...
<c:if test="${soHours.auditLevel eq '1'}">
    <form:form id="inputForm" modelAttribute="soHours" action="${ctx}/audit/reduceSecondAudit" method="post" class="form-horizontal">
        <form:hidden path="id"/>
        <form:hidden path="soid"/>
        <div class="control-group">
            <label class="control-label">是否通过：</label>
...
<c:if test="${soHours.auditLevel eq '2'}">
    <form:form id="inputForm" modelAttribute="soHours" action="${ctx}/audit/reduceThirdAudit" method="post" class="form-horizontal">
        <form:hidden path="id"/>
        <form:hidden path="soid"/>
        <div class="control-group">
            <label class="control-label">是否通过：</label>
