...
<body>
	...
	<form:form id="inputForm" modelAttribute="company" action="${ctx}/comp/company/save" method="post" class="form-horizontal">
        ...
        <table id="contentTable" class="table table-striped table-bordered table-condensed">
            ...
            <tr>
                ...
                <td><form:select path="companyType">
                    ...
                    <form:input path="portalCode" htmlEscape="false" maxlength="50" class="url input-block-level"/>
                </td>
