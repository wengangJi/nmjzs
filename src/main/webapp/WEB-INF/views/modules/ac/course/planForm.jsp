...
<ul class="nav nav-tabs">
  <li><a href="${ctx}/plan/list/">培训列表</a></li>
  <li class="active"><a href="${ctx}/plan/planForm?id=${plan.planId}">培训${not empty plan.planId?'修改':'添加'}</a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="plan" action="${ctx}/plan/savePlan" method="post" class="form-horizontal">
  ...
  <table id="invoiceTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        ...
        <td colspan="6"><form:input path="planName" htmlEscape="false"  class="required  input-medium" cssStyle="width: 850px;"/></td>
    </tr>
    <tr>
  ...
  <%--  <tr>
    ...
    <tr>
      ...
      <td><form:input path="planHours" htmlEscape="false"  class="required digits input-medium"/>(学时)
      </td>
      <td><label class="control-label">课件总数</label> </td>
      <td colspan="5"><form:input path="rsrvStr3" htmlEscape="false"  class=" number input-medium"/>(课)</td>
    </tr>
    <tr>
