...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/sys/initBatch">批次修改</a></li>
       <li><a href="${ctx}/sys/sys/initBatch">批次列表</a></li>
	</ul>
    <form:form id="inputForm" modelAttribute="sysBatch" action="${ctx}/sys/sys/batchUpdateStatus?status=16" method="post" class="form-horizontal">
    <form:input id="batchId" path="batchId" htmlEscape="false" class="required input-medium" value="${batchId}" cssStyle="display: none"/>
