...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/cp/assess/tasks">待办任务</a></li>
    <li><a href="${ctx}/cp/assess/warnTasks">超时待办</a></li><%--/warnTasks 是不是应该改成/cpAssClaimList-->
<%--    <li><a href="${ctx}/cp/assess/allTasks">所有任务</a></li>--%>
</ul>
<form:form id="cpForm" modelAttribute="soAssess" action="${ctx}/cp/assess/tasks" method="post" class="breadcrumb form-search">
...
<input type="hidden" id="isLocalAudit" value="${isLocalAudit}"/>
