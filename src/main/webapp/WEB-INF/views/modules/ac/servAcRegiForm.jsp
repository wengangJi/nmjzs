...
<form:form id="inputForm" modelAttribute="servAcInfo" action="${ctx}/ac/servAc/modifyAcRegiForm" method="post" class="form-horizontal">
...
<div class="tab-content">
    <div class="tab-pane active" id="cpTitle">
        <table id="contentTable" class="table table-bordered table-condensed  table-hover" >
            <thead>
            <tr align="center">
                <td colspan="8" style="text-align: center"><h3>二级建造师注册编号修改</h3></td>
            </tr>
            </thead>
            <tbody>
            <tr>
