...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitQueByUser() {
            ...
            $.ajax({
                type: "post",
                url: "${ctx}/exam/exam/makeResultToExamInfoDeatailAgain",
                ...
                success: function (msg) {
                    ...
                    //这里是否要提交展示 试卷页面
                   // window.location.href = "${ctx}/exam/exam/getQuestionListByTypeAgain?examInfoId=" + $("#examInfoId").val() + "&flag=1";
        ...
        function submitQueByTime() {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg.flag == 2) {
                        $.jBox.tip("试卷提交成功,作答试题数量为0.");
                        confirmx('考试时间已到，已经自动交卷。点击【确定】可查看试卷。', "${ctx}/exam/exam/getQuestionListByTypeAgain?examInfoId=" + $("#examInfoId").val() + "&flag=1");
        ...
        function timer(obj) {
            if ($("#beginBt").attr("disabled") == "disabled") {
                ...
                $.ajax({
                    type: "post",
                    url: "${ctx}/exam/exam/addDataInfoExamInfoAgain",
...
<form name="examForm" id="examForm" action="" modelAttribute="question">
    <div class="tab-pane" id="cpResume">
        ...
        <table class="table  table-bamordered table-condensed table-hover" id="questionTable" style="display: none">
