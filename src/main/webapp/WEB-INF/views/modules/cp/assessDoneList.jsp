...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/cp/assess/doneTasks">已办任务</a></li>
</ul>
<form:form id="cpForm" modelAttribute="soAssess" action="${ctx}/cp/assess/doneTasks" method="post" class="breadcrumb form-search">
...
--%>
            ...
            <td>
                ...
                &nbsp;
                <a href="${ctx}/cp/soCp/queryDetail?soid=${soAssess.so.soid}">审核历史</a>
