...
<link href="${ctxStatic}/bootstrap/2.3.1/css_red/bootstrap.min.css" type="text/css" rel="stylesheet" />
...
<script type="text/javascript" src="${ctxStatic}/jquery-jcrop/js/ajaxfileupload.js"></script>
<link href="${ctxStatic}/common/cims.min.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/cims.min.js" type="text/javascript"></script>
<script src="${ctxStatic}/print/webprinter.js" type="text/javascript"></script>
<link rel="shortcut icon" href="${ctxStatic}/favicon.ico">
<script src="${ctxStatic}/jquery-bootstrap-wizard/jquery.bootstrap.wizard.js"></script>