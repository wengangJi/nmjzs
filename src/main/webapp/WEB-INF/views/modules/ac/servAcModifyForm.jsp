...
<form:form id="inputForm" modelAttribute="servAcInfo" action="${ctx}/ac/servAc/modifyAcForm" method="post" class="form-horizontal">
<form:hidden path="servid" />
<form:hidden path="userId" value="${servAcInfo.userId}"/>
...
<div class="tab-content">
    <div class="tab-pane active" id="cpTitle">
        <table id="contentTable" class="table table-bordered table-condensed  table-hover" >
            <thead>
            <tr align="center">
                <td colspan="8" style="text-align: center"><h3>二级建造师信息修改</h3></td>
            </tr>
            </thead>
            <tbody>
            <tr>
                ...
                <td> <input id="birthDate" name="birthDate" type="text" readonly="readonly" maxlength="50"
                            class="input-medium Wdate"
                             value="<fmt:formatDate value="${servAcInfo.birthDate}" pattern="yyyy-MM-dd"/>"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
                </td>
            ...
            <tr>
                ...
                <td colspan="1"> <form:input path="contactPhone"  class="required input-medium"/></td>
         ...
         <%--   <tr>
            ...
            <tr>
                ...
                <td colspan="5"> <tags:commonselect id="companyId" name="companyId"  value="" labelName="companyName" labelValue="" title="查询企业" url="${ctx}/comp/company/findByName"/></td>
            </tr>

         <%--   <tr>
                <td><label class="control-label">联系人</label></td>
                <td><form:input path="contactPerson"   class="input-medium"/></td>
                <td><label class="control-label">联系电话</label></td>
                <td><form:input path="contactPhone"   class="input-medium"/></td>
            ...
            <tr>
                ...
                <td colspan="3"><form:input path="contactAddr"   class="input-medium"/></td>
                <td><label class="control-label">邮政编码</label></td>
                <td colspan="2"><form:input path="postCode"   class="input-medium"/></td>
            </tr>
            ...
            <tr>
                ...
                <td><input id="gardDate" name="gardDate" type="text" readonly="readonly" maxlength="50"
                           class="required input-medium Wdate"
                          value="<fmt:formatDate value="${servAcInfo.gardDate}" pattern="yyyy-MM-dd"/>" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/> </td>
            ...
            <tr>
                ...
                <td colspan="2">  <input id="workingDate" name="workingDate" type="text"
                                         maxlength="50" class="input-medium Wdate"     value="<fmt:formatDate value="${servAcInfo.workingDate}" pattern="yyyy-MM-dd"/>"
           ...
           <%-- <tr>
                ...
                <td colspan="3"> <input id="issueDate" name="issueDate" type="text" readonly="readonly"
                                        maxlength="50" class=" input-medium Wdate"     value="<fmt:formatDate value="${servAcInfo.issueDate}" pattern="yyyy-MM-dd"/>"
                                        onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>  </td>
            </tr>
            ...
            <tr>
                ...
                <td><label class="control-label">签发日期</label></td>
                <td colspan="2"><input id="regiDate" name="regiDate" type="text" readonly="readonly"
