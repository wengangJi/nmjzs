...
public  class PropertiesUtil {
    //配置文件的路径
    private String fileConfiDirectory = Global.getConfigDir();
 ...
 /*   *//**
     ...
     *//*
    public PropertiesUtil(String propName) throws IOException{
    ...
    *//**
     ...
     * @author 朱志杰
     * @throws java.io.FileNotFoundException 配置文件没有找到
     * @throws java.io.IOException 关闭资源文件，或者加载配置文件错误
     *
     *//*
...
*/
    public static void main(String[] args) {
        String configPath= Global.getConfigDir()+"/aliconfig.properties";
        PropertiesUtil p = new PropertiesUtil();
        try {
            System.out.println(p.readData(configPath,"partnerID"));
        } catch (Exception e) {
