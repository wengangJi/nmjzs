...
--%>
    <li><a href="#chooseLesson" data-toggle="tab">运维管理</a></li>
</ul>
...
<div class="tab-pane" id="chooseLesson">
    <div id="courseArea1">
        <form:form id="cpForm" modelAttribute="soPlanEntity" action="${ctx}/oper/operSoPlanList" method="post" class="breadcrumb form-search">
            ...
            <tr>
                ...
                <td>
                    <c:if test="${soplan.feeState eq '1'}">
                        <a href="${ctx}/oper/operProcess?soid=${soplan.soid}&planId=${soplan.planId}">学时管理</a>
                    </c:if>
                </td>
            </tr>
        </c:forEach>
