...
<table id="contentTable" class="table  table-bordered table-condensed table-hover">
    ...
    <c:forEach items="${soPlans}" var="soPlan">
        ...
        <tr>
           ...
           <%-- <c:if test="${soPlan.learnState eq '1'}">
                <td>
                    <a href="${ctx}/plan/findSoCourseBySoid?soid=${soPlan.soid}">已学课程</a>
                </td>
            </c:if>
            <c:if test="${soPlan.learnState eq '0'}">
                <td>
                    <a href="${ctx}/learn/findCourseListByPlanId?planId=${soPlan.planId}">在线学习</a>
                    <a href="${ctx}/plan/findSoNoCourseBySoid?soid=${soPlan.soid}&planId=${soPlan.planId}">未学课程</a>
                </td>
            </c:if>
--%>
