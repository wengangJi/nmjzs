 ...
 */
package com.zhongxin.cims.generate;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.zhongxin.cims.modules";
		
		String moduleName = "ac";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "AssociateConstructorBase";			// 类名，例：user
		String classAuthor = "liuqy";		// 类作者，例：ThinkGem
		String functionName = "二级建造师";			// 功能名，例：用户
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/zhongxin/cims/generate/template", "/", separator);
