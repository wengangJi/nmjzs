...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${cpTreeList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.parent?tpl.parent.id:0}', name:"${tpl.name}", url:"${ctx}/cp/soCp/${not empty tpl.module?tpl.module:'none'}?appId=${tpl.appId}&soType=${tpl.soType}&pageModule=${tpl.module}&sysTreeMenu.id=${tpl.id}", target:"cpMainFrame"},
		            </c:forEach>];
...
<body>
	<div class="accordion-group">
	    <div class="accordion-heading">
	    	<a class="accordion-toggle">三类人员申报列表</a>
	    </div>
