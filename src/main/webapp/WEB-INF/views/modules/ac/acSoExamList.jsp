...
<table id="contentTable" class="table  table-bordered table-condensed table-hover">
    ...
    <c:forEach items="${soPlans}" var="soPlan">
        ...
        <tr>
           ...
           <c:if test="${soPlan.feeState eq '1'  and soPlan.hourState eq '1' and soPlan.examState eq '0'}">
               <td>
                   <a href="${ctx}/exam/exam/examQuestionList?planId=${soPlan.planId}&soid=${soPlan.soid}" onclick="loading('正在查询，请稍等...');"> <i class="icon-white icon-play-circle"></i>进入考试</a>
               </td>
            </c:if>

            <c:if test="${soPlan.feeState eq '1' and soPlan.hourState eq '1' and (soPlan.examState eq '1' or soPlan.examState eq '4')}">
                <td>
                    <a href="${ctx}/exam/exam/examQuestionList?planId=${soPlan.planId}&soid=${soPlan.soid}"> <i class="icon-white icon-play-circle"></i>查看成绩</a>
                </td>
            </c:if>
