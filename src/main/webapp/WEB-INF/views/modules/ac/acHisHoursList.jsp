...
<form:form id="cpForm" modelAttribute="soHours" action="${ctx}/hours/qryHisHoursListInfo" method="post" class="breadcrumb form-search">
    ...
    <form:select id="qryStr4" path="qryStr4" class="input-medium"><form:options items="${fns:getDictList('AUDIT_LEVEL')}" itemLabel="label" itemValue="value" htmlEscape="false"/></form:select>&nbsp;
    ...
    <form:select id="qryStr3" path="qryStr3" class="input-medium"><form:options items="${fns:getDictList('AUDIT_TAG_QRY')}" itemLabel="label" itemValue="value" htmlEscape="false"/></form:select>&nbsp;
