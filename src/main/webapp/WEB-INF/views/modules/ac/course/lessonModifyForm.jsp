...
<ul class="nav nav-tabs">
  <li class="active"><a href="#">课件修改</a></li>
</ul><br/>
<form:form id="inputForm1" modelAttribute="lesson" action="${ctx}/lesson/modify" method="post" class="form-horizontal" enctype="multipart/form-data">
  <tags:message content="${message}"/>
    <form:hidden path="courseId" value="${lesson.courseCenter.courseId}"/>
    <form:hidden path="lessonIdTmp" value="${lesson.lessonId}"/>
